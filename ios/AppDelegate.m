...
//  RCTRootView *rootView = [[RCTRootView alloc] initWithBundleURL:jsCodeLocation moduleName:@"mediatest" initialProperties:nil launchOptions:launchOptions];
  ...
  [_callManager requestAuthorization:application bridge:_bridge appDelegate:self];
